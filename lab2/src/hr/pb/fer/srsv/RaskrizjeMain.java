...
public class RaskrizjeMain {
	...
	public static void main(String[] args) {
		...
		Vozilo voziloSmjerZS = new Vozilo(Smjer.ZS, racunalo);
		Vozilo voziloSmjerJZ = new Vozilo(Smjer.JZ, racunalo);
		Vozilo voziloSmjerIJ = new Vozilo(Smjer.IJ, racunalo);
		Vozilo voziloSmjerSI = new Vozilo(Smjer.SI, racunalo);
		Vozilo voziloSmjerJI = new Vozilo(Smjer.JI, racunalo);
		Vozilo voziloSmjerSZ = new Vozilo(Smjer.SZ, racunalo);
		Vozilo voziloSmjerIS = new Vozilo(Smjer.IS, racunalo);
		Vozilo voziloSmjerZJ = new Vozilo(Smjer.ZJ, racunalo);
